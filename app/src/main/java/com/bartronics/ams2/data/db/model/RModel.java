package com.bartronics.ams2.data.db.model;
...
public class RModel {
    ...
    @Generated(hash = 1987861886)
    public RModel() {
    }


    @Generated(hash = 722472942)
    public RModel(Long keyId, String empName, String empDescriton, String empNumber,
            int empId, int empPin, String empInTime, String empOutTime,
            String empInDate, String empLocation, String empDepartment,
            String empWorkLocation, String empDesignaiton) {
        this.keyId = keyId;
